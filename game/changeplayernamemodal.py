...
class ChangePlayerNameModal(Modal):
    def __init__(self, scene: Scene) -> None:
        ...
        self.current_name = scene.world.client.my_name
        ...
        self.back_button = Button(
            "뒤로 가기", pygame.Rect(0, 0, 150, 80), self.font, lambda _: self.close()
        )
        ...
        self.add_child(
            Vertical(
                ...
                [
                    ...
                    Horizontal(
                        pygame.Vector2(0, 0), 50, [self.back_button, self.accept_button]
                    ),
                ],
            )
        )
